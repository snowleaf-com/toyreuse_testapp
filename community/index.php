...
$communityDetail = getCommunity($currentMinNum, $span = 5, $wordSearch);
...
<?php endforeach; ?>
  ...
  <?php pagination( $communityDetail,$currentPageNum, $communityDetail['total_page'], $link, $pageColNum = 5, '', $currentMinNum, $listSpan) ?>
</main>
