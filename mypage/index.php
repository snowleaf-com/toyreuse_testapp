    ...
    <?php foreach($myFavoriteProd as $key => $val): ?>
      <div class="mypage_prod">
        <div class="mypage_prod_pic">
          ...
          <a href="../prod.php?p_id=<?php echo $val['id'] ?>"><p class="detail">商品ページへ</p></a>
        </div>
            ...
            <div class="mypage_prod">
              <div class="mypage_prod_pic">
                ...
                <?php if($val['bought_flg'] == 0) :?>
                  <a href="../prod.php?p_id=<?php echo $val['p_id'] ?>"><p class="detail">商品ページへ</p></a>
                  <p class="price">¥ <?php echo number_format((int)$val['price']) ?></p>
                  <a href="prod_edit.php?p_id=<?php echo $val['p_id'] ?>"><p class="edit">編集する</p></a>
                <?php else: ?>
                  <p class="soldout">SOUD OUT</p>
                  <a href="../prod_board.php?b_id=<?php echo $val['b_id'] ?>"><p class="detail">取引ページへ</p></a>
                  <p class="price">¥ <?php echo number_format((int)$val['price']) ?></p>
                <?php endif; ?>
              </div>
              <div class="mypage_prod_title">
