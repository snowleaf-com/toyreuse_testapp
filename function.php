...
function pagination( $productData, $currentPageNum, $totalPageNum, $link = '', $pageColNum = 5, $frontPagination = '', $currentMinNum, $listSpan){
...
function getCommunity($currentMinNum = 1, $span = 5, $wordSearch) {
  try {
    // DBへ接続
    $dbh = dbConnect();
    // 件数用のSQL文作成
