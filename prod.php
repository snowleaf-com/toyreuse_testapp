...
<main><!-- メイン大枠 -->
  ...
  <div class="main_wrap4">
    ...
    <div class="flex" style="background: #fff;margin-top: 10px;margin-bottom: 10px;border: 1px solid #000;">      
      ...
      <?php if(isLogin()): ?>
        <div id="sample">
            <div class="heart<?php if(isLike($_SESSION['user_id'], $p_id)) { echo ' active2';} ?>" width="70px" height="50px" data-detailid="<?php echo $productDetail
            ['id'] ?>"><p style="font-size:10px;color:#888;text-align:center;line-height:75px;">お気に入り!</p></div>
        </div>
      <?php endif;?>
    </div>
